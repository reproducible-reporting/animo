...
def test_a_deck_is_addressed_by_url(deck_at, page):
    ...
    The stand-in deck implements the contract of phase 05's runtime and nothing else.
    """
...
def test_the_reference_fixture_is_wired_to_the_test_module(references, request):
    ...
    which is the answer this phase gives to the question of how much of the suite
    genuinely needs stored pixels.
    """
