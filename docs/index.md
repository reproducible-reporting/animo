---
description: >-
  Animo is a presentation package for typst that keeps the content of a slide
  separate from its animation, and compiles one source file to three output types.
---
