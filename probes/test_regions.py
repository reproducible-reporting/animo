...
def test_a_footprint_measured_in_html_is_the_footprint_paged_produces(typst: TypstRunner):
    """One footprint rule serves both targets, which is what makes one source give four outputs.
...
def test_a_label_after_the_region_lands_identically_in_both_epoch_frames(
    ...
    typst transform in both. This is the assertion phases 08 and 09 are built on.
    """
